...
# Server Restore DB: `./DockerScript.sh RESTORE_FROM_BACKUP=./backups/streamtrack_2026-05-22_04-47-00.sql` to restore from a backup and start DB, API, and Caddy
# Local Restore DB: `./DockerScript.sh OCI_PROFILE=oracle RESTORE_FROM_BACKUP=./backups/streamtrack_2026-05-22_04-47-00.sql LOCAL_API=true` to restore from a backup and start DB, API, and IGNORE Caddy
